  ...
  [2],
  {
    ...
    pDpN: function(e, t) {
      ...
      function E(e, t, r) {
        let s = n(e, t);
        if (
          (!s && r && n(r, t) && (s = { enumerable: !0, configurable: !0 }), !s || !s.configurable)
        )
          return;
      ...
      function F(e, t, n) {
          ...
          p = function(t) {
            ...
            if (o)
              if (1 === o.length) u(o[0], n, t);
                ...
                for (
                  let o = 0;
                  o < e.length && (!t || !0 !== t.__zone_symbol__propagationStopped);
                  o++
                )
                  u(e[o], n, t);
              }
        ...
        function d(t, n) {
          ...
          const D = u
              ? function(e) {
                  if (!b.isExisting)
                    return S(e), v.call(b.target, b.eventName, b.capture ? f : p, b.options);
                }
              : function(e) {
            ...
            z = u
              ? function(e) {
                  ...
                  if (e.allRemoved)
                    return T.call(e.target, e.eventName, e.capture ? f : p, e.options);
                }
              : function(e) {
      ...
      const B = Zone.__symbol__,
        ...
        U = (Object[B('getOwnPropertyDescriptor')] = Object.getOwnPropertyDescriptor),
        W = Object.create,
        V = B('unconfigurables');
      function X(e, t, n) {
          ...
          (s = z(
            ...
            t =>
              function(n, o) {
                const r = o[0];
                let s;
                'number' == typeof r ? (s = i[r]) : ((s = r && r[pe]), s || (s = r)),
